...
// This is used in Draft view and returns JSON with score.
public class HandleFormScore implements RequestHandler<Map<String, Object>, String> {
    @Override
    public String handleRequest(Map<String, Object> event, Context context) {
        ...
        try {
            ...
            List<Details> details = service.getDataByIdWithScore(Long.valueOf(itemId));
